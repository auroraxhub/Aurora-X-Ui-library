...
-- ============================================================
-- Theme (Aurora "Emerald Green")
-- ============================================================
local Theme = {
    Background = Color3.fromRGB(18, 26, 18),
    Window     = Color3.fromRGB(22, 34, 24),
    Panel      = Color3.fromRGB(28, 44, 32),
    Header     = Color3.fromRGB(32, 48, 36),
    Elevated   = Color3.fromRGB(38, 56, 42),
    Primary    = Color3.fromRGB(40, 200, 85),
    Secondary  = Color3.fromRGB(30, 165, 70),
    Glow       = Color3.fromRGB(75, 235, 115),
    Accent     = Color3.fromRGB(60, 250, 100),
    Border     = Color3.fromRGB(28, 75, 38),
    BorderSoft = Color3.fromRGB(20, 55, 28),
    Text       = Color3.fromRGB(235, 245, 235),
    SubText    = Color3.fromRGB(155, 185, 160),
...
function Window.new(opts)
    ...
    -- Background image (fills window, clipped by ClipsDescendants)
    local bgImage = Util.new("ImageLabel", {
        Name = "Background",
        Image = "rbxassetid://122923415188495",
        BackgroundTransparency = 1,
...
-- ============================================================
-- REDZLIB COMPATIBILITY ALIASES
-- Provides redz-V5 API surface (MakeWindow/MakeTab/AddToggle/etc.)
-- so existing scripts can swap their loader and keep all logic.
-- ============================================================
...
function Window:NewMinimizer(mopts)
    ...
    function api:CreateMobileMinimizer(mmo)
        mmo = mmo or {}
        -- Real ImageButton so the script can manipulate .Image, .Parent, .ZIndex, etc.
        local btn = Util.new("ImageButton", {
            Name = "AuroraMobileMinimizer",
            Size = UDim2.new(0, 52, 0, 52),
            Position = UDim2.new(0, 20, 0, 120),
            BackgroundColor3 = mmo.BackgroundColor3 or Color3.fromRGB(255, 255, 255),
            BackgroundTransparency = mmo.BackgroundTransparency or 0.15,
            BorderSizePixel = 0,
            AutoButtonColor = false,
            Image = mmo.Image or "",
